...
class SignUpWindow(QWidget):
    def __init__(self):
        ...
        self.layout.addWidget(QLabel('SignUp', font=QFont("Arial", 24)))  # Corrected line
    ...
    def switch_to_login(self):
        self.hide()
        self.login_window = LoginWindow()  # Create an instance of the LoginWindow
        self.login_window.show()  # Show the LoginWindow
...
class LoginWindow(QWidget):
    def __init__(self):
        ...
        self.setStyleSheet("background-color: #808080; color: white;")
        self.layout = QVBoxLayout()
        self.layout.addWidget(QLabel('Login', font=QFont("Arial", 24)))  # Corrected line
