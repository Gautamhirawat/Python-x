...
def main():
     ...
     loadimages()
     running = True
     sqSelected  = () # no square is selected initialy , keep track of the last click of the user (tuple : row , col)
     ...
     while running:
          for e in p.event.get():
               if e.type == p.QUIT:
                    ...
                    location = p.mouse.get_pos() # it will give the location of mouse in (x,y)
