...
class MazeGame:
    def __init__(self, width, height, cell_size):
        ...
        self.player = self.canvas.create_rectangle(
            self.player_pos[0] * cell_size, self.player_pos[1] * cell_size,
            (self.player_pos[0] + 1) * cell_size, (self.player_pos[1] + 1) * cell_size,
            fill="blue"
        )
    ...
    def on_key_press(self, event):
        ...
        if self.player_pos == self.end_pos:
            ...
            messagebox.showinfo("Congratulations!", f"You reached the end! Time: {self.elapsed_time} seconds")
            self.root.quit()
